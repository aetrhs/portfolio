...
function About() {
  return (
    <div id='about-id' className='text-white flex flex-col justify-center m-auto text-center py-6 px-4 bg-gradient-to-b from-black via-gray-900 to-transparent'>
      <h2 className="font-bold text-3xl lg:text-4xl mb-8 text-[#FDF5AA]">
        <TypingEffect text="About Me" speed={100} delay={1500} className='font-bold'/>
      </h2>
      ...
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="text-center">
          <h3 className="text-xl lg:text-lg font-semibold mb-4 text-[#58A0C8]">Find me on</h3>
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center">
            <a href="https://github.com/aetrhs" target="_blank" rel="noopener noreferrer" 
              className="flex items-center gap-2 bg-gray-800/50 hover:bg-gray-700/50 px-6 py-3 rounded-lg transition-colors w-full sm:w-auto justify-center">
            ...
            <a href="https://linkedin.com/in/huda-hussin" target="_blank" rel="noopener noreferrer" 
              className="flex items-center gap-2 bg-blue-600/50 hover:bg-blue-600/70 px-6 py-3 rounded-lg transition-colors w-full sm:w-auto justify-center">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <a href="/cv.pdf" download 
              className="flex items-center gap-2 bg-green-600/50 hover:bg-green-600/70 px-6 py-3 rounded-lg transition-colors w-full sm:w-auto justify-center">
