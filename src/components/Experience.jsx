...
function Experience() {
  ...
  return (
    <div id='experience-id' className='text-white flex flex-col justify-center m-auto py-6 px-4'>
          ...
          {experiences.map((exp, index) => (
            <div key={index} className="relative">
              ...
              <div className="w-full">
                <div className="bg-gray-800/30 backdrop-blur-sm border border-gray-700/50 rounded-lg p-6 hover:bg-gray-700/40 transition-colors">
